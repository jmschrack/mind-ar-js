//require("./ui.scss");
const loadingHTML = `<div class="mindar-ui-overlay mindar-ui-loading"><div class="loader"/></div>`;//require('./loading.html').default;
const compatibilityHTML = `<div class="mindar-ui-overlay mindar-ui-compatibility"><div class="content">  <h1>Failed to launch :(</h1>  <p>    Looks like your device/browser is not compatible.  </p>  <br/>  <br/>  <p>    Please try the following recommended browsers:  </p>  <p>    For Android device - Chrome  </p>  <p>    For iOS device - Safari  </p></div></div>`;//require('./compatibility.html').default;
const scanningHTML = `<div class="mindar-ui-overlay mindar-ui-scanning"><div class="scanning">  <div class="inner">    <div class="scanline"/>  </div></div></div>`;//require('./scanning.html').default;
